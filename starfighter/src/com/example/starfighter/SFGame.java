...
public class SFGame extends Activity {
	...
	/**
	 * Oprava pro starsi zarizeni. getSize/getWidth a getHeight Vypocitana
	 * velikost dotykove plochy
	 * */
	...
	public boolean onTouchEvent(MotionEvent event) { // standardni naslouchani
		...
		if (y > SFEngine.playableArea) { // pokud jsem v hratelne zone
			...
			case MotionEvent.ACTION_DOWN: // je treba porovnat na ktere strane
											// obr. se hrac dotknul
